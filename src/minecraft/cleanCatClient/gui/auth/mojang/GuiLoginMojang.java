package cleanCatClient.gui.auth.mojang;
...
public class GuiLoginMojang extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new ClientButton(0, this.width / 2 - 50 - 10, this.height / 2, 120, 20, I18n.format("Login Mojang", new Object[0])));
