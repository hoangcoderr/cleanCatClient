...
public class CosmeticSatanWings extends CosmeticBase {
    private static final ResourceLocation TEXTURE = new ResourceLocation("cleanCatClient/Cosmetic/satanwings/wings.png");
    private final ModelSatanWings modelSatanWings;

    public CosmeticSatanWings(RenderPlayer renderPlayer) {
        super(renderPlayer);
