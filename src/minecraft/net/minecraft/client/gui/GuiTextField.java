...
public class GuiTextField extends Gui {
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            String s = FontUtil.normal.trimStringToWidth(this.text.substring(this.lineScrollOffset), this.getWidth());
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                j1 = FontUtil.normal
                        .drawStringWithShadow(s.substring(j), (float) j1, (float) i1, i);
            }
